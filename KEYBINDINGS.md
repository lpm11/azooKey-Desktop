...
| `Tab`                               | `.tab`                      | `composing`: **予測候補を受け入れ**。`attachDiacritic`: dead key + タブを挿入。                                                                                                                                              | 状態依存                                         |
...
| `↑` / `Ctrl-P`                      | `.navigation(.up)`          | `selecting`: 前候補へ。                                                                                                                                                                                                      | `composing` などでは多くが消費のみ               |
| `↓` / `Ctrl-N`                      | `.navigation(.down)`        | `composing`/`previewing`: 候補選択開始。`selecting`: 次候補へ。                                                                                                                                                              | 状態依存                                         |
